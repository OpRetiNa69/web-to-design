...
export const FeaturesSection: React.FC = () => {
  ...
  return (
    <section className="mt-28 mb-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-neutral-200/60 dark:border-neutral-800/60 pt-20">
      {/* 2-Column Editorial Headline & Intro */}
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
        <div className="max-w-xl">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50 leading-[1.1]">
            Designed for Speed.{' '}
            <span className="font-serif italic font-normal block text-neutral-500 dark:text-neutral-400">
              Zero manual inspection.
            </span>
          </h2>
        </div>
        <div>
          <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-lg max-w-md leading-relaxed">
            Extract computed color swatches, modular typography ladders, and border curves directly into production code.
          </p>
        </div>
      </div>

      {/* 3 Clean Borderless Columns */}
